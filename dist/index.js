...
const S3 = __webpack_require__(3575);
const fs = __webpack_require__(5747);
const path = __webpack_require__(5622);
const slash = __webpack_require__(787);
...
var AWS = __webpack_require__(5529);
 ...
 */
var AWS = { util: __webpack_require__(9790) };
...
AWS.util.update(AWS, {
   ...
   */
  Protocol: {
    Json: __webpack_require__(4173),
    Query: __webpack_require__(4710),
    Rest: __webpack_require__(9848),
    RestJson: __webpack_require__(6774),
    RestXml: __webpack_require__(6879)
  },
   ...
   */
  XML: {
    Builder: __webpack_require__(5402),
   ...
   */
  JSON: {
    Builder: __webpack_require__(3377),
    Parser: __webpack_require__(3552)
  },
   ...
   */
  Model: {
    Api: __webpack_require__(3315),
    Operation: __webpack_require__(8461),
    Shape: __webpack_require__(7324),
    Paginator: __webpack_require__(5010),
    ResourceWaiter: __webpack_require__(5751)
  },

  /**
   * @api private
   */
  apiLoader: __webpack_require__(8000),

  /**
   * @api private
   */
  EndpointCache: __webpack_require__(3062)/* .EndpointCache */ .$
});
...
var AWS = __webpack_require__(5529);
var STS = __webpack_require__(6650);
...
var AWS = __webpack_require__(5529);
var CognitoIdentity = __webpack_require__(7619);
var STS = __webpack_require__(6650);
...
var AWS = __webpack_require__(5529);
var util = __webpack_require__(9790);
...
var eventMessageChunker = __webpack_require__(7952).eventMessageChunker;
var parseEvent = __webpack_require__(2160).parseEvent;
...
var util = __webpack_require__(5529).util;
...
var parseMessage = __webpack_require__(573).parseMessage;
...
var Int64 = __webpack_require__(2744).Int64;

var splitMessage = __webpack_require__(2490).splitMessage;
...
var EventMessageChunkerStream = __webpack_require__(4350).EventMessageChunkerStream;
var EventUnmarshallerStream = __webpack_require__(8273).EventUnmarshallerStream;
...
var AWS = __webpack_require__(5529);
var SequentialExecutor = __webpack_require__(3810);
var DISCOVER_ENDPOINT = __webpack_require__(8107).discoverEndpoint;
/**
...
AWS.EventListeners = {
  ...
  Json: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(4173);
  ...
  Rest: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(9848);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  }),
  ...
  RestJson: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(6774);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  }),
  ...
  RestXml: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(6879);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  }),
  ...
  Query: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(4710);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  })
...
AWS.NodeHttpClient = AWS.util.inherit({
  handleRequest: function handleRequest(httpRequest, httpOptions, callback, errCallback) {
    ...
    var http = useSSL ? __webpack_require__(7211) : __webpack_require__(5876);
    var options = {
...
var Collection = __webpack_require__(435);
var Operation = __webpack_require__(8461);
var Shape = __webpack_require__(7324);
var Paginator = __webpack_require__(5010);
var ResourceWaiter = __webpack_require__(5751);
...
var memoizedProperty = __webpack_require__(9790).memoizedProperty;
...
var property = __webpack_require__(9790).property;
...
util.createEventStream = util.stream.Readable ?
  __webpack_require__(5604).createEventStream : __webpack_require__(2791).createEventStream;
util.realClock = __webpack_require__(2508);
util.clientSideMonitoring = {
  Publisher: __webpack_require__(5610).Publisher,
  configProvider: __webpack_require__(4010),
};
util.iniLoader = __webpack_require__(8742)/* .iniLoader */ .b;
 ...
 * @api private
 */
module.exports = AWS = __webpack_require__(5529);
...
var util = __webpack_require__(9790);
var JsonBuilder = __webpack_require__(3377);
var JsonParser = __webpack_require__(3552);
var populateHostPrefix = __webpack_require__(2415).populateHostPrefix;
...
var AWS = __webpack_require__(5529);
var util = __webpack_require__(9790);
var QueryParamSerializer = __webpack_require__(7542);
var Shape = __webpack_require__(7324);
var populateHostPrefix = __webpack_require__(2415).populateHostPrefix;
...
var util = __webpack_require__(9790);
var Rest = __webpack_require__(9848);
var Json = __webpack_require__(4173);
var JsonBuilder = __webpack_require__(3377);
var JsonParser = __webpack_require__(3552);
...
var AWS = __webpack_require__(5529);
var AcceptorStateMachine = __webpack_require__(807);
var inherit = AWS.util.inherit;
var domain = AWS.util.domain;
var jmespath = __webpack_require__(3900);
...
var AWS = __webpack_require__(5529);
var Api = __webpack_require__(3315);
var regionConfig = __webpack_require__(1262);
...
var AWS = __webpack_require__(5529);
var v4Credentials = __webpack_require__(9800);
var resolveRegionalEndpointsFlag = __webpack_require__(9102);
var s3util = __webpack_require__(9297);
var regionUtil = __webpack_require__(1262);
...
var IniLoader = __webpack_require__(3743).IniLoader;
/**
...
var util = {
  ...
  userAgent: function userAgent() {
    ...
    var agent = 'aws-sdk-' + name + '/' + __webpack_require__(5529).VERSION;
  ...
  date: {
    ...
    getDate: function getDate() {
      if (!AWS) AWS = __webpack_require__(5529);
  ...
  uuid: {
    v4: function uuidV4() {
      return __webpack_require__(8085).v4();
    }
  },
...
var util = __webpack_require__(9790);
var XmlNode = __webpack_require__(8094).XmlNode;
var XmlText = __webpack_require__(8592).XmlText;
...
var xml2js = __webpack_require__(8871);
...
var escapeAttribute = __webpack_require__(2870).escapeAttribute;
...
var escapeElement = __webpack_require__(8321).escapeElement;
...
var LRU_1 = __webpack_require__(386);
var CACHE_SIZE = 1000;
/**
...
var v1 = __webpack_require__(3737);
var v4 = __webpack_require__(9203);
...
var rng = __webpack_require__(4148);
var bytesToUuid = __webpack_require__(6645);
...
(function() {
  ...
  builder = __webpack_require__(2366);

  defaults = __webpack_require__(9945).defaults;
...
(function() {
  ...
  sax = __webpack_require__(7089);

  events = __webpack_require__(8614);

  bom = __webpack_require__(970);

  processors = __webpack_require__(8605);
...
(function() {
  ...
  defaults = __webpack_require__(9945);

  builder = __webpack_require__(8079);

  parser = __webpack_require__(5801);
...
(function() {
  ...
  XMLNode = __webpack_require__(9530);
...
(function() {
  ...
  isObject = __webpack_require__(773).isObject;
...
(function() {
  ...
  XMLDTDAttList = __webpack_require__(5931);

  XMLDTDEntity = __webpack_require__(3824);

  XMLDTDElement = __webpack_require__(4744);

  XMLDTDNotation = __webpack_require__(9773);
...
(function() {
  ...
  isPlainObject = __webpack_require__(773).isPlainObject;

  XMLNode = __webpack_require__(9530);

  XMLStringifier = __webpack_require__(2425);

  XMLStringWriter = __webpack_require__(7093);
...
(function() {
  ...
  ref = __webpack_require__(773), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject;

  XMLElement = __webpack_require__(8255);

  XMLCData = __webpack_require__(4178);

  XMLComment = __webpack_require__(2953);

  XMLRaw = __webpack_require__(9908);

  XMLText = __webpack_require__(9003);

  XMLProcessingInstruction = __webpack_require__(6171);

  XMLDeclaration = __webpack_require__(9001);

  XMLDocType = __webpack_require__(1007);
  ...
  XMLAttribute = __webpack_require__(4081);
...
(function() {
  ...
  ref = __webpack_require__(773), isObject = ref.isObject, isFunction = ref.isFunction;
...
(function() {
  ...
  ref = __webpack_require__(773), isObject = ref.isObject, isFunction = ref.isFunction, isEmpty = ref.isEmpty;
...
(function() {
  ...
  XMLWriterBase = __webpack_require__(8905);
...
(function() {
  ...
  ref = __webpack_require__(773), assign = ref.assign, isFunction = ref.isFunction;

  XMLDocument = __webpack_require__(7307);

  XMLDocumentCB = __webpack_require__(3541);

  XMLStringWriter = __webpack_require__(7093);

  XMLStreamWriter = __webpack_require__(4430);
